...
<body>
    ...
    <div class="container preload">
     ...
     <center>
     <form id="paymentForm" action="cardcheck.php" method="post">
    <div class="form-container">
        <div class="field-container">
            <label for="name">Name</label>
            <input id="cardname" required name="cardname" maxlength="20" type="text">
        </div>
        <div class="field-container">
            <label for="cardnumber">Card Number</label><span id="generatecard">Generate random</span>
            <input id="cardnum" required name="cardnum" type="text" inputmode="numeric">
        ...
        <div class="field-container">
            ...
            <input id="cardexp" required name="cardexp" type="text" inputmode="numeric">
        </div>
        <div class="field-container">
            <label for="securitycode">Security Code</label>
            <input id="cardcvv" required name="cardcvv" type="text"  inputmode="numeric">
        </div>
        
        <button class="paymentbtn" type="submit" style="margin-left: 111px;" >Confirm Order</button>
...
var cardnum_mask = new IMask(cardnum, {
    mask: [
        {
...
var cardexp_mask = new IMask(cardexp, {
    mask: 'MM{/}YY',
    groups: {
...
var cardcvv_mask = new IMask(cardcvv, {
    mask: '0000',
});
...
cardnum_mask.on("accept", function () {
    console.log(cardnum_mask.masked.currentMask.cardtype);
    switch (cardnum_mask.masked.currentMask.cardtype) {
...
const randomCard = function () {
    ...
    cardnum_mask.unmaskedValue = testCards[randomNumber];
}
...
cardnum_mask.on('accept', function () {
    if (cardnum_mask.value.length == 0) {
        document.getElementById('svgnumber').innerHTML = '0123 4567 8910 1112';
    } else {
        document.getElementById('svgnumber').innerHTML = cardnum_mask.value;
    }
});

cardexp_mask.on('accept', function () {
    if (cardexp_mask.value.length == 0) {
        document.getElementById('svgexpire').innerHTML = '01/23';
    } else {
        document.getElementById('svgexpire').innerHTML = cardexp_mask.value;
    }
});

cardcvv_mask.on('accept', function () {
    if (cardcvv_mask.value.length == 0) {
        document.getElementById('svgsecurity').innerHTML = '985';
    } else {
        document.getElementById('svgsecurity').innerHTML = cardcvv_mask.value;
    }
});
